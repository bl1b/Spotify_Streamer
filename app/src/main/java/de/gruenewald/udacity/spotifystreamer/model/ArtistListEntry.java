...
public class ArtistListEntry implements Parcelable {
    ...
    public void setCoverUrlLarge(String pCoverUrlLarge) {
        mCoverUrlLarge = pCoverUrlLarge;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(mCoverUrlLarge);
    }
}
